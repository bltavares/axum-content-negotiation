...
lint:
	...
	cargo clippy --all --no-default-features --features form-urlencoded,default-json -- -D warnings
.PHONY: lint
...
lint-fix:
	...
	cargo clippy --fix --all --no-default-features --features form-urlencoded,default-json -- -D warnings
.PHONY: lint-fix
...
lint-pedantic:
	...
	cargo clippy --no-default-features --features form-urlencoded,default-json -- -D clippy::pedantic
.PHONY: lint-pedantic
...
check:
	...
	cargo check --all --no-default-features --features form-urlencoded,default-json
.PHONY: check
...
test:
	...
	cargo bin cargo-nextest run --all --no-default-features --features form-urlencoded,default-json
.PHONY: test
